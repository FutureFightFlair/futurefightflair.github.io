...
flair.selectChoice = function (hero_id, key) {
    ...
    flair.by_id[hero_id].hero_attribute = flair.by_id[hero_id].hero_name.replace(/.*?(\#[^)]*\#).*?/g, "$1").replace(/#L#/g, "<img src='images/icons/position_leader.png' title='Leadership'></img> ").replace(/#S#/g, "<img src='images/icons/position_support.png' title='Team Support'></img> ").replace(/#D#/g, "<img src='images/icons/position_dealer.png' title='Damage Dealer'></img> ").replace(/#PVE#/g, "<img src='images/icons/position_pve.png' title='PVE Oriented'></img> ").replace(/#PVP#/g, "<img src='images/icons/position_pvp.png' title='PVP Oriented'></img> ").replace(/#Cry#/g, "<img src='images/icons/acquire_crystalwall.png' title='Crystalwall'></img> ").replace(/#P#/g, "<img src='images/icons/acquire_paywall.png' title='Paywall'></img> ").replace(/#Cra#/g, "<img src='images/icons/acquire_craft.png' title='Craft'></img> ").replace(/#C#/g, "<img src='images/icons/cost_costly.png' title='Costly'></img> ").replace(/#E#/g, "<img src='images/icons/cost_expensive.png' title='Expensive'></img> ").replace(/#Lu#/g, "<img src='images/icons/cost_luxe.png' title='Luxe'></img> ").replace(/#Energy#/g, "<img src='images/icons/ctp_energy.png' title='CTP Energy'></img> ").replace(/#Rage#/g, "<img src='images/icons/ctp_rage.png' title='CTP Rage'></img> ").replace(/#Regen#/g, "<img src='images/icons/ctp_regen.png' title='CTP Regeneration'></img> ").replace(/#Transcendence#/g, "<img src='images/icons/ctp_transcendence.png' title='CTP Transcendence'></img> ").replace(/#Insight#/g, "<img src='images/icons/ctp_insight.png' title='CTP Insight'></img> ").replace(/#Destruction#/g, "<img src='images/icons/ctp_destruction.png' title='CTP Destruction'></img> ").replace(/#Judgement#/g, "<img src='images/icons/ctp_judgement.png' title='CTP Judgement'></img> ").replace(/#Patience#/g, "<img src='images/icons/ctp_patience.png' title='CTP Patience'></img> ").replace(/#Veteran#/g, "<img src='images/icons/ctp_veteran.png' title='CTP Veteran'></img> ").replace(/#Authority#/g, "<img src='images/icons/ctp_authority.png' title='CTP Authority'></img> ").replace(/#Refinement#/g, "<img src='images/icons/ctp_refinement.png' title='CTP Refinement'></img> ").replace(/#Greed#/g, "<img src='images/icons/ctp_greed.png' title='CTP Greed'></img> ");
